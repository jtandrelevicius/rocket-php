   ...
   public function save($data)
   {
    ...
    public function get_all()
    {
       $this->db->select([
           ...
           'vendedores.vendedor_nome_completo as nome_vendedor',
       ]);
    ...
    public function get_all_produtos($venda_id=NULL)
    {
       if ($venda_id) {
        ...
        $this->db->join('produtos', 'produto_id = venda_produto_id_venda', 'left');
        $this->db->where('venda_produto_id_venda', $venda_id);
        $this->db->group_by('venda_produto_id_produto');
        $this->db->get('venda_produtos')->result();
       }
    }
    ...
    public function get_valor_final_relatorios($data_inicial=NULL, $data_final=NULL)
    {
