...
class Ordem_servico_model extends CI_Model
{
    ...
    public function get_all()
    {
        ...
        $this->db->select([
            'ordens_servicos.*',
            'clientes.cliente_id',
            'clientes.cliente_nome as cliente_nome',
    ...
    public function get_valor_final_relatorios_os($data_inicial=NULL, $data_final=NULL)
    {
        $this->db->select([
          'FORMAT(SUM(REPLACE(ordem_servico_valor_total, ",", "")), 2) as valor_total',
        ]);
