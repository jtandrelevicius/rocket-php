      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <label class="form-label required">CEP</label>
              <div class="col-2">
                 <input type="text" class="form-control input_cep" name="vendedor_cep" id="cep" placeholder="CEP" value="<?php echo $vendedor->vendedor_cep?>">
                 </div>
                   <div class="col-auto">
          ...
          <div class="row">
            ...
            <textarea class="form-control" name="vendedor_obs" rows="4" placeholder="Observação.."><?php echo $vendedor->vendedor_obs?></textarea>
            </div>
