            ...
            <div class="row align-items-center mw-100">
                ...
                <div class="col-auto">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo base_url('fornecedores/add')?>" class="btn btn-primary">
                ...
                <table class="table card-table table-vcenter text-nowrap dataTable">
                    ...
                    <?php foreach ($fornecedor as $fornecedor) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo ($fornecedor->fornecedor_ativo == 1 ? '<span class="badge bg-success me-1"></span>ativo' : '<span class="badge bg-danger me-1"></span>inativo')?>
  
                                </td>

                                <td class="text-end">
                                    <a title="Editar" href="<?php echo base_url('fornecedores/edit/' .$fornecedor->fornecedor_id) ?>" class="btn btn-lista btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                    <a title="Excluir" href="<?php echo base_url('fornecedores/del/' .$fornecedor->fornecedor_id) ?>" class="btn btn-lista btn-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
