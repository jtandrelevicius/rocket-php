        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="form-group col-2 ">
              ...
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_cnpj?>">
          ...
          <div class="row">
            <div class="form-group col-2 ">
              ...
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_ie?>">
            ...
            <div class="form-group col-2">
              ...
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_celular?>">
            ...
            <div class="form-group col-6 ">
              ...
              <div>
                ...
                <?php echo form_error('fornecedora_email', '<small class="form-text text-danger">','</small>')?>
              </div>
          </div>
          ...
          <div class="form-group col-3 ">
              ...
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_contato?>">
                <?php echo form_error('fornecedora_contato', '<small class="form-text text-danger">','</small>')?>
              </div>
          </div>
          ...
          <label class="form-label required">CEP</label>
              <div class="col-2">
                 <input type="text" class="form-control input_cep" name="fornecedor_cep" id="cep" placeholder="CEP" value="<?php echo $fornecedor->fornecedor_cep?>">
                 </div>
                   <div class="col-auto">
          ...
          <div class="form-group col-4 ">
            ...
            <div class="form-group col-1 ">
              ...
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_numero_endereco?>">
            ...
            <label class="form-label required ">UF</label>
              <div>
                ...
                value="<?php echo $fornecedor->fornecedor_estado?>">
          ...
          <div class="row">
            ...
            <textarea class="form-control" name="fornecedor_obs" rows="4" placeholder="Observação.."><?php echo $fornecedor->fornecedor_obs?></textarea>
            </div>
