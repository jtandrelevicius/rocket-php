...
<div class="content">
  <div class="container-fluid">
    <form action="" method="POST" name="form_marcas">
      <!-- Page title -->
          ...
          <div class="col">
            <div class="mb-1">
              <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                <li class="breadcrumb-item"><a href="<?php echo base_url('marcas') ?>">Lista de Serviços</a></li>
          ...
          <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
              <span class="d-none d-sm-inline">
                <a href="<?php echo base_url('marcas') ?>" class="btn btn-white">
                  Cancelar
                </a>
              </span>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="form-group col-10 ">
              ...
              <div>
                <input type="text" class="form-control" name="marca_nome" placeholder="Nome" 
            ...
            <div class="form-group col-2">
              ...
              <select class="form-select" name="marca_ativa">
