            ...
            <div class="row align-items-center mw-100">
                ...
                <div class="col-auto">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo base_url('clientes/add')?>" class="btn btn-primary">
                ...
                <table class="table card-table table-vcenter text-nowrap dataTable">
                    ...
                    <?php foreach ($clientes as $cliente) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo ($cliente->cliente_ativo == 1 ? '<span class="badge bg-success me-1"></span>ativo' : '<span class="badge bg-danger me-1"></span>inativo')?>
  
                                </td>

                                <td class="text-end">
                                    <a title="Editar" href="<?php echo base_url('clientes/edit/' . $cliente->cliente_id) ?>" class="btn btn-lista btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                    <a title="Excluir" href="<?php echo base_url('clientes/del/' .$cliente->cliente_id) ?>" class="btn btn-lista btn-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
