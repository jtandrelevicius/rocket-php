      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-2 ">
                            ...
                            <div class="input-icon">
                                ...
                                <input class="form-control" type="date" name="conta_pagar_data_vencto" placeholder="00/00/0000" id="datepicker-icon-prepend" value="<?php echo set_value('conta_pagar_data_vencto')?>">
                            </div>
                        </div>
          ...
          <div class="row">
              ...
              <textarea class="form-control" name="conta_pagar_obs" rows="4" placeholder="Observação"><?php echo set_value('conta_pagar_obs')?></textarea>
