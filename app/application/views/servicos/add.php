      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <label class="form-label required">Descrição<span class="form-label-description">0/180</span></label>
            <textarea class="form-control" name="servico_descricao" rows="4" placeholder="Descrição"><?php echo set_value('servico_descricao')?></textarea>
