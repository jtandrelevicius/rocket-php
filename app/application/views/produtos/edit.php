                  ...
                  <div>
                    <div class="row">
                      ...
                      <div class="form-group col-2 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_codigo" placeholder="Codigo" value="<?php echo $produtos->produto_codigo ?>">
                      ...
                      <div class="form-group col-7 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_descricao" placeholder="Descrição" value="<?php echo $produtos->produto_descricao ?>">
                      ...
                      <div class="form-group col-2 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_codigo_barras" placeholder="7890000000000" value="<?php echo $produtos->produto_codigo_barras ?>">
                      ...
                      <div class="form-group col-1 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_unidade" placeholder="UN" value="<?php echo $produtos->produto_unidade ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-3 ">
                        ...
                        <div>
                          <input type="text" class="form-control input_dinheiro2" name="produto_preco_custo" placeholder="R$ 0.00" value="<?php echo $produtos->produto_preco_custo ?>">
                      ...
                      <div class="form-group col-3 ">
                        ...
                        <div>
                          <input type="text" class="form-control input_dinheiro2" name="produto_preco_venda" placeholder="R$ 0.00" value="<?php echo $produtos->produto_preco_venda ?>">
                      ...
                      <div class="form-group col-3 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_qtde_estoque" placeholder="Estoque" value="<?php echo $produtos->produto_qtde_estoque ?>">
                      ...
                      <div class="form-group col-3 ">
                        ...
                        <div>
                          <input type="text" class="form-control" name="produto_estoque_minimo" placeholder="Estoque Minimo" value="<?php echo $produtos->produto_estoque_minimo ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-4">
                        ...
                        <select class="form-select" name="produto_fornecedor_id">
                          ...
                          <?php foreach ($fornecedores as $fornecedor) : ?>
                            <option value="<?php echo $fornecedor->fornecedor_id ?>" <?php echo ($fornecedor->fornecedor_id == $produtos->produto_fornecedor_id ? 'selected' : '') ?>><?php echo $fornecedor->fornecedor_nome_fantasia ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group col-3">
                        ...
                        <select class="form-select" name="produto_marca_id">
                          ...
                          <?php foreach ($marcas as $marca) : ?>
                            <option value=" <?php echo $marca->marca_id ?>" <?php echo ($marca->marca_id == $produtos->produto_marca_id ? 'selected' : '') ?>><?php echo $marca->marca_nome ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group col-3">
                        ...
                        <select class="form-select" name="produto_categoria_id">
                          ...
                          <?php foreach ($categorias as $categoria) : ?>
                            <option value="<?php echo $categoria->categoria_id ?>" <?php echo ($categoria->categoria_id == $produtos->produto_categoria_id ? 'selected' : '') ?>><?php echo $categoria->categoria_nome ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group col-2">
                        ...
                        <select class="form-select" name="produto_ativo">
                          <option value="0" <?php echo ($produtos->produto_ativo == 0) ? 'selected' : '' ?>>Não</option>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-12">
                        ...
                        <textarea class="form-control" name="produto_observacao" rows="4" placeholder="Observação"><?php echo $produtos->produto_obs ?></textarea>
